...
class WorkTargetController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            // Admin, Boss, CEO melihat semua target
    ...
    public function subordinates(Request $request)
    {
        ...
        // Admin, Boss, CEO dapat melihat semua karyawan dan manager
        if (in_array($user->role, ['admin', 'boss', 'ceo'])) {
    ...
    public function stats(Request $request)
    {
        ...
        // Admin, Boss, CEO stats - semua target
        if (in_array($user->role, ['admin', 'boss', 'ceo'])) {
    ...
    public function store(Request $request)
    {
        ...
        // Only manager, admin, boss, ceo can create targets
        if (!in_array($user->role, ['manager', 'admin', 'boss', 'ceo'])) {
    ...
    public function update(Request $request, string $id)
    {
        ...
        // Admin, boss, ceo can update any target
    ...
    public function destroy(string $id)
    {
        ...
        // Admin, boss, ceo can delete any target
