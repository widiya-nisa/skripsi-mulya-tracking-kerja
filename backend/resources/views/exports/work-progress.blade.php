    ...
    <table>
        <thead>
            <tr>
                ...
                <th width="30%">Catatan Progress</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->workTarget->title ?? '-' }}</td>
                <td>{{ Str::limit($item->progress_note, 100) }}</td>
                <td style="text-align: center;">{{ $item->percentage }}%</td>
                <td style="text-align: center;">{{ $item->attachments->count() }}</td>
                <td>
            ...
            @empty
            <tr>
                <td colspan="8" style="text-align: center; padding: 20px;">Tidak ada data progress kerja</td>
            </tr>
            @endforelse
        </tbody>
    </table>
