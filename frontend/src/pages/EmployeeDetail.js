                ...
                <div className="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-8">
                    <div className="flex items-center">
                        ...
                        <div className="ml-6 text-white">
                            ...
                            <p className="text-blue-100 text-lg mt-1">{profile.position || 'Karyawan'}</p>
                            <div className="flex items-center mt-3 space-x-4">
                                ...
                                <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold ${
                                    profile.employment_status === 'permanent' ? 'bg-green-500' :
                                    profile.employment_status === 'contract' ? 'bg-blue-500' :
                                    profile.employment_status === 'probation' ? 'bg-yellow-500' : 'bg-gray-500'
                                }`}>
                                    {profile.employment_status === 'permanent' ? 'Karyawan Tetap' :
                    ...
                    <div className="border-b pb-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p className="font-medium">{profile.birth_place || '-'}, {profile.birth_date || '-'}</p>
                            </div>
                            <div>
                            ...
                            <div>
                                <label className="text-sm text-gray-600">Status Pernikahan</label>
                    ...
                    <div>
                        ...
                        {(profile.ktp_file || profile.ijazah_file || profile.cv_file) ? (
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                {profile.ktp_file && (
                                    <a href={`/storage/${profile.ktp_file}`} target="_blank" rel="noopener noreferrer" 
                                ...
                                {profile.ijazah_file && (
                                    <a href={`/storage/${profile.ijazah_file}`} target="_blank" rel="noopener noreferrer" 
                                ...
                                {profile.cv_file && (
                                    <a href={`/storage/${profile.cv_file}`} target="_blank" rel="noopener noreferrer" 
