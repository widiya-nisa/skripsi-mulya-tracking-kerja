...
function EmployeeEdit() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            showNotification(error.response?.data?.message || 'Gagal mengupdate profil', 'error');
        } finally {
            setSubmitting(false);
        }
    };
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-800">Edit Profil Karyawan</h2>
                    <button
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="text-center py-8 text-gray-600">
                        Silakan gunakan halaman Profil Pribadi untuk edit profil karyawan ini.
                        <br />
                        <button
                            type="button"
                            onClick={() => navigate('/employee-management')}
